...
def send_mail_function():
    recipientEmail="venkamsetty.naveen@gmail.com"
    recipientEmail=recipientEmail.lower()
    try:
        server = smtplib.SMTP('smtp.gmail.com', 587)
        server.ehlo()
        server.starttls()
        server.login("firedetection.ucen@gmail.com","bjcarmldfdbsmpkz")
        server.sendmail("firedetection.ucen@gmail.com",recipientEmail,"Warning A Fire Accident has been reported on company ABC")
...
# Example usage
video_path = 'fire1.mp4'  # Replace with the path to your video
Email_Status=False
